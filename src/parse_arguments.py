...
def parse_arguments(in_hp={}, in_evaluation={}, in_run={}):
    ...
    with open('siamfc_pytorch_test/parameters/hyperparams.json') as json_file:
        hp = json.load(json_file)
    with open('siamfc_pytorch_test/parameters/evaluation.json') as json_file:
        evaluation = json.load(json_file)
    with open('siamfc_pytorch_test/parameters/run.json') as json_file:
        run = json.load(json_file)
    with open('siamfc_pytorch_test/parameters/environment.json') as json_file:
        env = json.load(json_file)
    with open('siamfc_pytorch_test/parameters/design.json') as json_file:
